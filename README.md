...
Abra seu terminal linux e cole o comando:

``` bash
sudo apt update && sudo apt upgrade && sudo apt install python3 && git clone https://github.com/Zer0ne0011/HackTools-Linux && cd HackTools-Linux && chmod +x install.py && sudo python3 install.py && python3 HackTools.py
```

Após apenas abrir o "HackTools.py"
